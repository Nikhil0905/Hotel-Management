#PROJECT BY SHIVAM TIWARI AND NIKHIL SHAKYA
...
def Home():
	...
	print("\t\t        WELCOME TO HOTEL S&N TAJ\n")
	print("\t\t     IT'S OUR PLEASURE TO SERVE YOU\n")
	print("\t\t\t       1 Booking\n")
	print("\t\t\t       2 Rooms Info\n")
	print("\t\t\t       3 Menu Card\n")
	print("\t\t\t       4 Payment\n")
...
def Booking():
		...
		if ch==0:
			print(" 1. Standard Non-AC - Rs. 4500")
			print(" 2. Standard AC - Rs. 5000")
			print(" 3. 3-Bed Non-AC - Rs. 8000")
...
Home()
#BIBLIOGRAPHY-1.GOOGLE, 2.PGT COMP MR.DEVINDER, 3.FRIENDS, 4.SENIORS
